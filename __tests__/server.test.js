...
describe('Server Tests', () => {
  ...
  it('should respond with 200 and a message on a GET to /', async () => {
    ...
    expect(response.text).toEqual('Welcome to the plant.space E-Commerce API & Socket Server!');
  });

  it('should respond with 500 when reaching an error', async () => {
    const response = await mockRequest.post('/orders');
